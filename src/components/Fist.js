...
const cardData = [
  { id: 1, image: fist1, description: 'Card 1 Description' },
  { id: 2, image: fist2, description: 'Card 2 Description' },
  { id: 3, image: fist3, description: 'Card 3 Description' },
];
...
const Fist = () => {
  ...
  return (
    <div className="dnd">
      <h1
        className={`heading ${headingInView ? 'in-view' : ''}`}
        ref={headingRef}
      >
        F.I.S.T
      </h1>
      <p
        className={`paragraph ${paragraphInView ? 'in-view' : ''}`}
        ref={paragraphRef}
      >
      ...
      <div
        className={`cards ${cardsInView ? 'in-view' : ''}`}
        ref={cardsRef}
      >
        {cardData.map((card) => (
